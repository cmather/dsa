...
export class GraphSearch {
  constructor(graph, start, opts = {}) {
    assert(graph instanceof Graph, `GraphSearch constructor requires a Graph but got ${graph}`);
    assert(start instanceof Vertex, `GraphSearch constructor requires a starting Vertex but got ${start}`);
